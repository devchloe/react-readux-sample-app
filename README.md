...
If you want to change the API URL to a local server, simply edit `src/routes.js` and change `API_ROOT` to the local server's URL (i.e. `http://localhost:3000/api`)
